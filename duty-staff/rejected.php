                                ...
                                <table class="table v-middle">
                                    <thead>
                                        <tr class="bg-light">
                                            ...
                                            <th class="border-top-0">Date Rejected</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php 
                                          ...
                                          $sql="select * from tbl_duty where duty_staff='$dutystaff' and duty_status='rejected' order by duty_date desc limit 20";
                                          ...
                                          do{
                                            ...
                                            $sql5 = "SELECT * FROM tbl_user_details where username='$dmgrname'" ;
                                            $result5 = mysqli_query($DBcon,$sql5);
                                            while ($rowdutymgr5 = mysqli_fetch_array($result5)){
                                            echo ucwords($rowdutymgr5['names']);
                                            echo "</td>";
                                          }
                                       
                                            echo "<td>"; echo '<small id="name45" class="badge badge-default badge-danger form-text text-white">'; echo ucwords($row['duty_status']); echo '</small>'; echo "</td>";
