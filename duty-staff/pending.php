                                ...
                                <table class="table v-middle">
                                    ...
                                    <tbody>
                                        <?php 
                                          ...
                                          $sql="select * from tbl_duty where duty_staff='$dutystaff' and duty_status='' order by duty_date desc limit 20";
                                          ...
                                          do{
                                            ...
                                            echo "<td>"; echo '<small id="name45" class="badge badge-default badge-warning form-text text-white">Pending approval</small>';echo "</td>";
                                            echo "</tr>";
                                          }
