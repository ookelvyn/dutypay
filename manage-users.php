                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material" method='post'>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="password" minlength="5" name='password' class="form-control form-control-line" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Re-enter Password</label>
                                        <div class="col-md-12">
                                            <input type="password" minlength="5" name='password1' class="form-control form-control-line" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" placeholder="" name='fullname' class="form-control form-control-line" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Account Number</label>
                                        <div class="col-md-12">
                                            <input type="number" min="0" placeholder="" name='accnumber' class="form-control form-control-line" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
